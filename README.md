...
```bash
caddy list-modules | grep -E '(dns.providers.cloudflare|caddy.security|caddy.storage.cloudflare_kv|http.encoders.br|http.handlers.rate_limit|layer4|http.handlers.waf)'
```
